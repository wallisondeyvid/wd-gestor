...
const ERROR_MESSAGE = 'Controllers do Gestor não podem importar repositories diretamente. Use services.';
...
test('Guardrail estrutural: controllers do Gestor não podem importar repositories diretamente', () => {
