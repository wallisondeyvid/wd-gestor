...
const ERROR_MESSAGE = 'Controllers do Gestor não podem importar usecases diretamente. Use services/ como fachada.';
...
test('Guardrail estrutural: controllers do Gestor não podem importar usecases diretamente', () => {
