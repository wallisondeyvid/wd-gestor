...
const ERROR_MESSAGE = 'Controllers do Gestor não podem importar services/legacy diretamente. Controllers devem depender apenas de services/ (fachada).';
...
test('Guardrail estrutural: controllers do Gestor não podem importar services/legacy diretamente', () => {
