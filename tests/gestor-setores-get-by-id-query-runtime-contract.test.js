...
export async function deleteSetor(req, res) { return res.status(200).json({ success: true, data: { deleted: true } }); }
...
async function requestWithSession({ pathname, sessionUser } = {}) {
  const app = express();
